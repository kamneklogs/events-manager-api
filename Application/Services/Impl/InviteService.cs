...
public class InviteService : IInviteService
{
    ...
    public async Task<InviteRetrievalDto> CreateInvite(int eventId, string developerEmail)
    {
        ...
        if (_unitOfWork.InviteRepository.Find(i => i.EventEntity.Id == eventId && i.DeveloperEntity.Email == developerEmail, i => i.DeveloperEntity, i => i.EventEntity).FirstOrDefault() is not null)
        {
